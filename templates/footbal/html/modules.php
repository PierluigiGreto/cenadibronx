...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'style-nostyle';
  $styles = array(
    'style-nostyle' => 'modChrome_artnostyle',
    'style-block' => 'modChrome_artblock',
    'style-article' => 'modChrome_artarticle',
    'style-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'style-...'        - overwrites module style.
  //  'style-... suffix' - overwrites style and adds suffix to the module root tag and
  //                     to the module elements, does not add style-... to the module elements.
  $classes = '';
...
<div class="style-nostyle<?php echo $params->get('artx-module-classes'); ?>">
